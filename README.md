...
* Can perform battery State of Charge (SoC) calculation using Coulomb Counting and Open Circuit Voltage methods
...
* Kann den Batterieladezustand (SoC) berechnen, mittels Coulomb Counting und Open-Circuit-Voltage-Verfahren
...
LocalWords: pl load csv yield configuration yaml SolBatHome
-->
